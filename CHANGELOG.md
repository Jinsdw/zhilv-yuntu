...
山海拾光（智旅云图）首个可运行版本：多 Agent 协同的智能旅游行程规划助手。
...
### 变更
- 项目名称由「智旅云图」更改为「山海拾光（智旅云图）」：全局更新 README.md、配置（PROJECT_NAME / VITE_APP_TITLE）、前端品牌、导出模板、文档与脚本注释；英文标识 zhilv-yuntu、目录与文件名保持不变。
